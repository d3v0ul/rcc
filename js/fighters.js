    ...
    $(function () {
        if (document.querySelector(".mf_strikes")) {
            ...
            $(window).scroll(function () {
                var scrollEvent =
                    $(window).scrollTop() >
                    target_block.position().top + 400 - $(window).height();
                if (scrollEvent && blockStatus) {
                    ...
                    let progressStartValue = 0,
                        progressEndValue = parseInt(
                            (parseInt(
                                document
                                    .querySelector(".n1_1")
                                    .getAttribute("data-strikes")
                            ) /
                                parseInt(
                                    document
                                        .querySelector(".n1_2")
                    ...
                    let progress = setInterval(() => {
                        ...
                        circularProgress.style.background = `conic-gradient(${colorPaint} ${
                    ...
                    if (document.querySelector(".circular-progress2")) {
                        let circularProgress2 = document.querySelector(
                                ".circular-progress2"
                            ),
                            progressValue2 =
                                document.querySelector(".progress-value2");

                        let progressStartValue2 = 0,
                            progressEndValue2 = parseInt(
                                (parseInt(
                                    document
                                        .querySelector(".n1_1")
                                        .getAttribute("data-strikes")
                        ...
                        let progress2 = setInterval(() => {
                            ...
                            circularProgress2.style.background = `conic-gradient(${colorPaint} ${
                    ...
                    if (document.querySelector(".circular-progress3")) {
                        let circularProgress3 = document.querySelector(
                                ".circular-progress3"
                            ),
                            progressValue3 =
                                document.querySelector(".progress-value3");

                        let progressStartValue3 = 0,
                            progressEndValue3 = parseInt(
                                (parseInt(
                                    document
                                        .querySelector(".n1_1")
                                        .getAttribute("data-strikes")
                        ...
                        let progress3 = setInterval(() => {
                            ...
                            circularProgress3.style.background = `conic-gradient(${colorPaint} ${
                    ...
                    if (document.querySelector(".circular-progress4")) {
                        let circularProgress4 = document.querySelector(
                                ".circular-progress4"
                            ),
                            progressValue4 =
                                document.querySelector(".progress-value4");

                        let progressStartValue4 = 0,
                            progressEndValue4 = parseInt(
                                (parseInt(
                                    document
                                        .querySelector(".n1_1")
                                        .getAttribute("data-strikes")
                        ...
                        let progress4 = setInterval(() => {
                            ...
                            circularProgress4.style.background = `conic-gradient(${colorPaint} ${
                    ...
                    if (document.querySelector(".circular-progress5")) {
                        let circularProgress5 = document.querySelector(
                                ".circular-progress5"
                            ),
                            progressValue5 =
                                document.querySelector(".progress-value5");

                        let progressStartValue5 = 0,
                            progressEndValue5 = parseInt(
                                (parseInt(
                                    document
                                        .querySelector(".n1_1")
                                        .getAttribute("data-strikes")
                        ...
                        let progress5 = setInterval(() => {
                            ...
                            circularProgress5.style.background = `conic-gradient(${colorPaint} ${
                    ...
                    if (document.querySelector(".circular-progress6")) {
                        let circularProgress6 = document.querySelector(
                                ".circular-progress6"
                            ),
                            progressValue6 =
                                document.querySelector(".progress-value6");

                        let progressStartValue6 = 0,
                            progressEndValue6 = parseInt(
                                (parseInt(
                                    document
                                        .querySelector(".n1_1")
                                        .getAttribute("data-strikes")
                        ...
                        let progress6 = setInterval(() => {
                            ...
                            circularProgress6.style.background = `conic-gradient(${colorPaint} ${
